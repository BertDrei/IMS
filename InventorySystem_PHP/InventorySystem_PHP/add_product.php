...
if (isset($_POST['add_product'])) {
  $req_fields = array('case-number', 'full-name', 'age', 'sex', 'date-of-birth', 'place-of-birth', 'address', 'educational-attainment', 'civil-status', 'occupation', 'religion', 'company-agency', 'monthly-income', 'employment-status', 'contact-number', 'email-address', 'pantawid-beneficiary', 'lgbtq');
  ...
  if (empty($errors)) {
    ...
    if ($db->query($query)) {
      $application_form_id = $db->insert_id();
        ...
        <div class="col-md-12">
          ...
          <form method="post" action="add_product.php" class="clearfix">
            ...
            <div class="row d-flex align-items-center">
              ...
              <div class="col-md-2 d-flex justify-content-end">
                <div class="form-group mb-0">
                  <input type="text" class="form-control" name="case-number" placeholder="Case Number">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <select class="form-control civil-status" name="civil-status">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control contact-number" name="contact-number"
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group">
                  <select class="form-control pantawid-beneficiary" name="pantawid-beneficiary">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <select class="form-control lgbtq" name="lgbtq">
            ...
            <div id="family-composition-section">
              <div class="family-member">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="family-member-birthday">Date of Birth</label>
                      <input type="date" class="form-control" name="family-member-birthday[]"
                        id="family-member-birthday" placeholder="Birthday (mm/dd/yy)">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" class="form-control" name="family-member-occupation[]"
